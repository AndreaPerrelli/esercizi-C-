namespace esempioClasseRiferimento
{
    ...
    class MainProgram
    {
        ...
        {
            dimostrazioneClasseRiferimento();
            dimostrazioneArrayRiferimento();
        }

        private static void dimostrazioneClasseRiferimento()
        {
        ...
        private static void dimostrazioneArrayRiferimento()
        {
            Console.WriteLine(Environment.NewLine);
